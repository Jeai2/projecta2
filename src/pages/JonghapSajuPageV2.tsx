...
import { SewoonV2 } from "@/components/results/v2/sections/SewoonV2";
import { ChongronV2 } from "@/components/results/v2/sections/ChongronV2";
...
const JonghapSajuPageV2 = () => {
  ...
  const renderSection = () => {
    ...
    switch (resultCurrentPage) {
      ...
      case 10: return <SewoonV2 />;
      case 11: return <ChongronV2 />;
