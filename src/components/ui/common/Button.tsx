...
import { type VariantProps } from "class-variance-authority"; // [수정] 'cva'는 설계도 파일로 넘어갔으므로, 여기서는 '타입'만 가져온다.
import { cn } from "@/lib/utils";
import { buttonVariants } from "./buttonVariants"; // [수정] './buttonVariants.ts' 파일에서 설계도를 정확히 import한다.
