...
export const sibiwunseongDescriptions: Record<string, SibiwunseongDesc> = {
  장생: {
    ...
    bongbeopRgb: "255, 95, 95",
    geopbeopRgb: "255, 130, 130",
  },
  목욕: {
    hanja: "沐浴",
    keyword: "Bathing",
    ...
    bongbeopRgb: "255, 150, 50",
    geopbeopRgb: "255, 175, 90",
  },
  관대: {
    hanja: "冠帶",
    keyword: "Capping",
    ...
    bongbeopRgb: "245, 195, 30",
    geopbeopRgb: "240, 200, 70",
  },
  건록: {
    hanja: "建祿",
    keyword: "Prosperity",
    ...
    bongbeopRgb: "160, 200, 50",
    geopbeopRgb: "180, 210, 80",
  },
  제왕: {
    hanja: "帝旺",
    keyword: "Peak",
    ...
    bongbeopRgb: "50, 185, 100",
    geopbeopRgb: "80, 195, 120",
  },
  쇠: {
    hanja: "衰",
    keyword: "Decline",
    ...
    bongbeopRgb: "40, 175, 175",
    geopbeopRgb: "70, 190, 190",
  },
  병: {
    hanja: "病",
    keyword: "Illness",
    ...
    bongbeopRgb: "60, 140, 210",
    geopbeopRgb: "90, 160, 220",
  },
  사: {
    hanja: "死",
    keyword: "Death",
    ...
    bongbeopRgb: "55, 80, 170",
    geopbeopRgb: "80, 100, 185",
  },
  묘: {
    hanja: "墓",
    keyword: "Tomb",
    ...
    bongbeopRgb: "75, 55, 150",
    geopbeopRgb: "100, 80, 165",
  },
  절: {
    hanja: "絶",
    keyword: "Extinction",
    ...
    bongbeopRgb: "100, 45, 130",
    geopbeopRgb: "120, 65, 145",
  },
  태: {
    hanja: "胎",
    keyword: "Embryo",
    ...
    bongbeopRgb: "145, 75, 115",
    geopbeopRgb: "165, 95, 135",
  },
  양: {
    hanja: "養",
    keyword: "Nurture",
    ...
    bongbeopRgb: "180, 105, 115",
    geopbeopRgb: "195, 125, 135",
  },
};
